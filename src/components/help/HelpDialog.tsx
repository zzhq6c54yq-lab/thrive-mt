...
const HelpDialog: React.FC<HelpDialogProps> = ({ isOpen, onOpenChange }) => {
  const [messages, setMessages] = useState<Array<{ text: string; isUser: boolean }>>([
    { text: "Hi there! I'm here to help. What can I assist you with today?", isUser: false }
  ]);
  ...
  const handleSendMessage = (message: string) => {
    ...
    setTimeout(() => {
      setMessages(prev => [
        ...prev, 
        { 
          text: "Thank you for your message. I'm here to help you navigate through the app and provide support. What specific area would you like to explore?", 
          isUser: false 
        }
      ]);
    }, 1000);
