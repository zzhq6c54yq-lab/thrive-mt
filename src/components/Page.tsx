...
const Page: React.FC<PageProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a1a1f] via-[#242432] to-[#272730] text-white py-4 px-2 sm:px-3 md:px-4 relative">
      ...
      <div className={`${fullWidth ? 'w-full max-w-none' : 'max-w-5xl mx-auto'} backdrop-blur-md rounded-2xl p-4 sm:p-5 shadow-xl relative overflow-hidden`}>
        {/* Decorative elements */}
