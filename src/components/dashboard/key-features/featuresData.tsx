...
export const getFeatures = (isSpanish: boolean): FeatureItem[] => [
  ...
  },
  {
    ...
    path: "/app/substance-abuse-sponsor",
    color: "emerald"
  },
  {
    id: "music-therapy",
