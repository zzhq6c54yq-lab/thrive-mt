      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button 
            variant="outline" 
            size="icon" 
            className="h-16 w-16 rounded-full border-3 border-[#B87333] bg-white shadow-lg hover:bg-[#B87333]/10 transition-all duration-300 hover:shadow-[0_0_15px_#B87333]"
            aria-label="User menu"
          >
            <User className="h-8 w-8 text-[#B87333]" />
          </Button>
        </DropdownMenuTrigger>
