...
const GoldenYearsWelcome: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#8B6F1D] via-[#B89237] to-[#DAB258] text-white py-8 px-4 relative">
      ...
      <div className="max-w-5xl mx-auto bg-[#00000040] backdrop-blur-md rounded-2xl p-8 shadow-xl border border-amber-300/30 relative overflow-hidden">
        {screenState === 'welcome' ? (
          <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4 animate-fade-in">
            ...
            <div className="max-w-3xl mx-auto mb-10">
              ...
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-amber-200/30 mb-8 text-left">
            ...
            <Button 
              ...
              className="bg-gradient-to-r from-amber-500 to-amber-400 hover:from-amber-600 hover:to-amber-500 text-white text-lg px-8 py-6 h-auto transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
          ...
          <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4 animate-fade-in">
            ...
            <div className="max-w-3xl mb-10 w-full">
              <div className="bg-gradient-to-r from-amber-800/40 to-amber-800/40 backdrop-blur-sm rounded-xl p-6 border border-amber-300/30 mb-8">
